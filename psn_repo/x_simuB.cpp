...
//		表示
//------------------------------------------------------------------------------
long x_simuB::disp_man_one( HDC hdc , long index )
{
...
//-------------------------------------------------------------------------------------
void x_simuB::real_to_view( double rx1 , double ry1 , double* vx1 , double* vy1 )
{
...
//-------------------------------------------------------------------------------------
void x_simuB::view_to_real( double vx1 , double vy1 , double* rx1 , double* ry1 )
{
...
//		一人の移動
//------------------------------------------------------------------------------
long x_simuB::next_step_one( long index )
{
	//
...
//		次の位置に移動可能かどうかチェック
//------------------------------------------------------------------------------
long	x_simuB::check_next_position( long index )
{
...
//	進行方向と直交するベクトルを作成する
//------------------------------------------------------------------------------
long	x_simuB::make_fuzzy_new_vector( long index )
{
...
//		相手から受ける影響の程度
//-------------------------------------------------------------------------------------
double x_simuB::fuzzy_suiron(long my_index , long aite_index )
{
...
//		台形の面積
//----------------------------------------------------------------------------
double	 x_simuB::xfunc_daikei_area(double height, double bottom_length , double top_height )
{
...
//----------------------------------------------------------------------------
double	 x_simuB::xfunc_fuzzy_strong( double val , double start_pos , double end_pos )
{
	double	strongness=		0;
